<?php
    ...
    $name = $_POST['name-elite'];
    $phone = $_POST['phone-elite'];
    $email = $_POST['e-mail-elite'];
    ...
    <body>
        <table height="22px">
            <caption>
                <h1>Привіт, '.$name .',<br> Вас відатє <span>СуперФорма OnLine</span></h1><br><h2>Ви обрали пакет <span>ELITE</span></h2>
            </caption>
            <tr>
